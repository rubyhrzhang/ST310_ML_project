...
In summary, random forest as a method outperforms linear models. This is not surprising given the nonlinearity nature of the data and its high-dimensionality, especially with the full dataset. By grouping the `track_genre` into 11 categories, we lost some valuable information.
